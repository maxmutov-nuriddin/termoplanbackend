...
import { ISmeta } from '../models/Smeta';
 ...
 */
export async function generateProjectPdfBuffer(data: PdfProjectData): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    try {
      ...
      itemsToDisplay.forEach((it: any, index: number) => {
