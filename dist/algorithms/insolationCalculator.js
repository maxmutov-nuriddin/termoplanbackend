...
exports.calculateSolarGeometry = calculateSolarGeometry;
exports.calculateWindAnalysis = calculateWindAnalysis;
exports.angleToCardinal = angleToCardinal;
exports.analyzeInsolation = analyzeInsolation;
const climateData_1 = require("../config/climateData");
/**
 * Berilgan koordinata (kenglik) bo'yicha quyosh geometriyasini hisoblash
 */
function calculateSolarGeometry(latitude) {
 ...
 */
function calculateWindAnalysis(region, compassAngle) {
 ...
 */
function analyzeInsolation(regionId, compassNorthAngle, walls, windows) {
    const climate = climateData_1.UZBEKISTAN_CLIMATE_DATA[regionId] || climateData_1.UZBEKISTAN_CLIMATE_DATA['tashkent'];
    ...
    for (let i = 0; i < walls.length; i++) {
        ...
        const factorInfo = climateData_1.ORIENTATION_FACTORS[cardinal] || climateData_1.ORIENTATION_FACTORS.NORTH;
